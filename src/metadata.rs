...
pub enum Instruction {
    ...
    CastClass(Type),
    /// CLI type test: return a compatible reference (a box for value targets), or null.
    #[serde(rename = "isinst")]
    IsInstance(Type),
    ...
    #[serde(rename = "box")]
    BoxValue(Type),
    /// Copy an exact boxed value payload; never expose an interior reference.
    #[serde(rename = "unbox.any")]
    UnboxAny(Type),
    #[serde(rename = "ref.eq")]
    ReferenceEqual,
