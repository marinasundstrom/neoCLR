...
| --- | --- |
| [System.Storage](xref:System.Storage) | [StorageItem, File and Directory](storage-items.md), [FileText](xref:System.Storage.FileText), [StorageProvider](xref:System.Storage.StorageProvider) for [item lookup](storage-provider.md), [Path](xref:System.Storage.Path), InvalidPathError, [Metadata.GetKind](xref:System.Storage.Metadata), EntryKind and StorageLookupError; see the [lookup guide](storage-lookup.md) |
