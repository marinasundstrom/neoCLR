...
| --- | --- |
| [System.Storage](xref:System.Storage) | [StorageItem, File and Directory](storage-items.md), [FileText](xref:System.Storage.FileText), [StorageLookup](xref:System.Storage.StorageLookup), [StorageProvider](xref:System.Storage.StorageProvider) for [byte access](storage-provider.md), [Path](xref:System.Storage.Path), InvalidPathError, [Metadata.GetKind](xref:System.Storage.Metadata), EntryKind and StorageLookupError; see the [lookup guide](storage-lookup.md) |
