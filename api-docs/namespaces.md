...
| `System.Web.Http` | Development bounded HTTP client, request/response/content and replaceable handler pipeline. | [Web guide](/features/web/), [reference](xref:System.Web.Http) |
...
| `System.Linq` | Query operators over iterable collections, including filtering, projection and terminal operations. Optional and single-result queries use explicit outcomes, with SingleError for cardinality failures. | [Query reference](xref:System.Linq) · [Collections and queries](/features/collections/index.html) |
| `System.Math` | Integer and floating-point functions, including Abs, Min, Max, Clamp, rounding, roots and trigonometry. Integer Abs reports overflow and Clamp reports an invalid range through Result. | [Math reference](xref:System.Math) · [Expected outcomes](/features/outcomes/index.html). |
...
| `System.Text` | UnicodeScalar helpers, strict Utf8 encoding/decoding and UTF-8 error types. String itself lives in System. | [Text reference](xref:System.Text) · [Strings and UTF-8](/features/strings/index.html) |
