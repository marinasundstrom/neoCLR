...
| `System.Networking.Sockets` | Development IPv4 TCP client with asynchronous Connect and Receive, explicit Close and typed SocketError. | [Guide](sockets.md), [reference](xref:System.Networking.Sockets) |
