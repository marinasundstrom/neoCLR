...
- A platform-written [System library](runtime/System.neoil): overloaded
  ...
  `System.Math.Abs`, assembled into the same metadata/IL representation as apps.
...
Current format version 2 requires structured call signatures; reassemble earlier
source after adding explicit signatures to calls.
