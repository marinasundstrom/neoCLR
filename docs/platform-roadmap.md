...
**Author-requested Console convenience:** object display fallback and unboxed
Boolean/Char/integer WriteLine overloads accompany the entry-argument work; see
[Console contract](console-io.md). Floating-point formatting remains deferred.
...
**Reflection execution checkpoint:** [private runtime construction](reflection-execution.md)
