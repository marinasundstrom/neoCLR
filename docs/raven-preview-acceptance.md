...
| Propagation | Success continues; failure returns a compatible carrier; incompatible carriers are rejected | Next feature slice; the interface belongs to neoCLR's runtime library |
