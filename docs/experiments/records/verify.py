...
with tempfile.TemporaryDirectory(prefix='neoclr-records-') as folder:
    ...
    for declaration in ('record struct Unsupported(Number: int)', 'record class Unsupported(Name: string?)', 'record class Unsupported(Value: object)', 'record class Unsupported(Value: int?)'):
