            ...
            while (work.TryDequeue(out var index))
            {
                ...
                switch (instruction.OpCode.Code)
                {
                    ...
                    case Code.Newobj:
                        ...
                        if (collectionProfile && (ReaderBindings.Bind(constructor, constructorDefinition, true) ?? FileSystemBindings.Bind(constructor, constructorDefinition, true) ?? StorageItemBindings.Bind(constructor, constructorDefinition, true) ?? StreamBindings.Bind(constructor, constructorDefinition, true, libraryOwner is not null) ?? WorkerBindings.Bind(constructor, constructorDefinition, true, libraryOwner is not null) ?? AsyncBindings.Bind(constructor, constructorDefinition, true) ?? TaskBindings.Bind(constructor, constructorDefinition, true, libraryOwner is not null)) is { } taskConstruction)
                        {
