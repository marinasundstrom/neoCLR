...
static class FileBindings
{
    ...
    public const string Declarations = """
        namespace IO { public static class File {
    ...
    {
        if (reference.DeclaringType.FullName != "System.IO.File") return null;
        ...
        if (!reference.HasThis && ((reference.Name == "ReadAllText" && args.SequenceEqual(new[] { "String", "Int32" })
                && result == "System.Result<String,System.IO.FileReadError>")
            || (reference.Name == "WriteAllText" && args.SequenceEqual(new[] { "String", "String", "Int32" })
                && result == "System.Result<Void,System.IO.FileWriteError>")))
            return new("System.IO.File::" + reference.Name, args, result);
