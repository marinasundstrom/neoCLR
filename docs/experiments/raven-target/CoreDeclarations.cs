...
static class CoreDeclarations
{
    ...
    public static void Write(string path, bool includeConsole = true, bool stringParameter = true, bool unionProbe = false, bool collectionProbe = false, bool libraryBootstrap = false)
    {
        ...
        if (collectionProbe) declarations += WorkerBindings.Declarations + TaskBindings.ForReference(libraryBootstrap) + Utf8Bindings.Declarations + UnicodeScalarBindings.Declarations + QueryBindings.Declarations + OutcomeOperatorBindings.Declarations + CollectionDeclarations.Source + ReflectionBindings.Declarations + ReflectionBindings.ProviderDeclarations + NativeMemoryBindings.Declaration + InterfaceBindings.Declarations;
        ...
        if (unionProbe)
        {
            ...
            if (collectionProbe) { IntrospectionHierarchy.Project(module); TaskBindings.Project(module); WorkerBindings.Project(module); ReaderBindings.Project(module); }
