...
static class ReflectionBindings
{
    ...
    public const string ProviderDeclarations = """
        ...
        namespace Introspection { internal abstract class RuntimeMemberInfo { public int MetadataToken => default; public ModuleInfo Module => default; protected RuntimeMemberInfo() { } public string Name => default; public System.Option<System.Introspection.TypeInfo> DeclaringType => default; } }
