...
static class ReflectionBindings
{
    ...
    public static string? Type(TypeReference type)
    {
        ...
        if ((ReferenceTypes.Contains(type.FullName) || type.FullName is "System.Runtime.Reflection.TypeReflectionExtensions" or "System.Runtime.Reflection.PropertyReflectionExtensions") && !type.IsValueType) return type.FullName;
    ...
    public static void Validate(ModuleDefinition module)
    {
        ...
        foreach (var name in ReferenceTypes)
        {
            ...
            var parents = name is "System.Introspection.FieldInfo" or "System.Introspection.MethodInfo" or "System.Introspection.PropertyInfo"
                ? new[] { "System.Introspection.MemberInfo" } : name == "System.Introspection.TypeInfo" ? new[] { "System.Introspection.MemberInfo", "System.EquatableTo`1<System.Introspection.TypeInfo>" } : Array.Empty<string>();
