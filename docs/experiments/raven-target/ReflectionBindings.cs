...
{
    public static readonly string[] ReferenceTypes = ["System.Runtime.RuntimeContext", "System.Introspection.TypeInfo", "System.Introspection.ParameterInfo", "System.Introspection.MemberInfo", "System.Introspection.FieldInfo", "System.Introspection.MethodInfo", "System.Introspection.PropertyInfo"];
    ...
    public const string Declarations = """
        ...
        namespace Runtime { public sealed class RuntimeContext { private RuntimeContext() { } public static RuntimeContext Current => default; public System.Introspection.TypeInfo GetTypeInfoFromHandle(System.RuntimeTypeHandle handle) => default; } }
        namespace Introspection { public interface TypeInfo : System.Equatable<TypeInfo> { string Name { get; } string FullName { get; } string Namespace { get; } int GenericArgumentCount { get; } bool IsArray { get; } bool IsByRef { get; } bool IsPointer { get; } bool IsInterface { get; } bool IsReadOnly { get; } bool IsAbstract { get; } bool IsEnum { get; } bool IsValueType { get; } TypeInfo GetGenericArgument(int index); bool Equals(TypeInfo other); TypeInfo[] GetGenericArguments(); System.Option<TypeInfo> GetElementType();  System.Option<System.Introspection.TypeInfo> BaseType { get; } System.Introspection.TypeInfo[] GetInterfaces(); string[] GetEnumNames(); System.Introspection.TypeInfo GetEnumUnderlyingType(); FieldInfo[] GetFields(); FieldInfo[] GetFields(BindingFlags flags); MethodInfo[] GetMethods(); MethodInfo[] GetMethods(BindingFlags flags); PropertyInfo[] GetProperties(); PropertyInfo[] GetProperties(BindingFlags flags); } }
        namespace Introspection { public interface ParameterInfo { string Name { get; } int Position { get; } System.Introspection.TypeInfo ParameterType { get; } bool IsOut { get; } bool IsOutWhenTrue { get; } bool IsReadOnly { get; } } }
        namespace Introspection { public interface MemberInfo { string Name { get; } System.Introspection.TypeInfo DeclaringType { get; } } }
