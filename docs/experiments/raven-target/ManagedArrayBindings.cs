...
static class ManagedArrayBindings
{
    ...
    public static bool IsReference(string type) => ApplicationTypes.IsReference(type) || type == "String" || type == "System.Object" || IsType(type)
    ...
    public static void CheckElement(Code code, string element, string? token)
    {
        var valid = code switch {
            ...
            Code.Ldelem_U2 => element is "UInt16" or "Char",
            Code.Stelem_I2 => element is "Int16" or "UInt16" or "Char",
            Code.Ldelem_I4 => element == "Int32",
            Code.Ldelem_U4 => element == "UInt32",
