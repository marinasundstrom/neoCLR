...
static class ManagedArrayBindings
{
    ...
    public static bool IsReference(string type) => StorageItemBindings.IsName(type) || ApplicationTypes.IsReference(type) || type == "String" || type == "System.Object" || IsType(type)
