...
| Fundamental interfaces | ComparableTo/EquatableTo value and class implementations, collection contracts and Disposable; [interfaces](raven-fundamental-interfaces.md). Clonable/Closable declarations and calls are available, but have no concrete implementations in the existing library |
