...
| Array, ArrayList, List, Iterable, Iterator | [Closed collection elements and Copy](raven-generic-collections.md), Int32/String vectors, class aliasing and foreach | [Predicate APIs](raven-delegate-api.md) are projected; [native Array<T> buffers](raven-native-buffer-api.md) are projected; remaining element shapes; preserve reference categories and document cleanup limits |
