...
`~/.neoclr/experiments/record-components-20260924/Platform.code-workspace`.
...
Run `~/.neoclr/experiments/record-components-20260924/open-vscode.sh` to open it
...
record-class components and a direct Object base. Nullable components and record
...
passes 45 tests; the runtime reference-slot suite passes 32. The prior hash suite
