...
member. Divide, instance comparisons/formatting, error constructors, checked case
accessors and error ToString remain coverage work. The metadata/error catalog now
