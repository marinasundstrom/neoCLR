...
| Files and console | Bounded text-file/console operations; development directional file streams with Result outcomes and explicit close | Align Storage and explore a Path value object using the tested disk/memory stream sample; keep async lifetime and scheduling open |
