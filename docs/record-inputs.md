...
primitive and ordinary Option/Result inputs. Parameters may contain nested records,
...
in a record or a erased Option/Result payload, or ignored by the function body.
