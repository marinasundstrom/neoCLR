...
include external memory access and P/Invoke, stack addresses/allocation, checked numeric conversions, and explicit layout/ABI controls. Integer and floating-point
