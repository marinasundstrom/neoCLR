...
this preliminary pattern support and a prototype LINQ layer. Next validate
extension-method targeting, then a small Iterable/Iterator query surface. See [the scoped plan](platform-backlog.md#raven-patterns-and-prototype-linq-2026-09-13).
