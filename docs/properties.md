...
mutation and construction/initialization remain separate prerequisites. Accessibility,
automatic properties, property attributes, and a guest reflection API are not introduced.
