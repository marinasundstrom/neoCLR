...
[direct-union investigation](experiments/http-error-unions/README.md) now executes nested standard declarations, empty-case-only unions and separately
compiled dependencies through the bridge;
