...
fn socket_submission_requires_socket_and_dispatch_services() {
    ...
    let program = LoadedProgram::new(&module).unwrap();
    for signature in ["SocketConnect(String,Int32,System.Func<Void>)", "SocketReceive(Int64,arrayref<Byte>,Int32,Int32,System.Func<Void>)", "SocketSend(Int64,arrayref<Byte>,Int32,Int32,System.Func<Void>)"] {
