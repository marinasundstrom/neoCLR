...
fn arithmetic_failures_are_errors_when_requested() {
    for (body, expected) in [
        ...
        (
            "ldstr \"2147483648\"\ncall System.Int32.Parse(string)\ncall instance System.Result<Int32,Error>::GetErr()\ncall instance System.Err<Error>::get_Value()\nret",
            "InvalidInt32",
        ),
    ] {
...
fn all_implemented_opcodes_have_a_sample() {
    ...
    let samples = [
        ...
        include_str!("../examples/memory.neoil"),
        include_str!("../examples/stack.neoil"),
        include_str!("../examples/control-flow.neoil"),
        include_str!("../examples/arguments.neoil"),
        include_str!("../examples/layout.neoil"),
        include_str!("../examples/comparison-branches.neoil"),
